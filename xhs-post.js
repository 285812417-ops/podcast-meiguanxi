...
const COOKIES = [
  ...
  { name: 'access-token-creator.xiaohongshu.com', value: 'customer.creator.AT-68c517614152588410650626wdks8cgamw0g6qzx',                                        domain: '.xiaohongshu.com',         path: '/' },
  { name: 'acw_tc',                             value: '0a0d068317728080262694356e7f0c4afd7152877eac3a8579f8688c21a3bd',                                          domain: 'creator.xiaohongshu.com',  path: '/' },
  { name: 'customer-sso-sid',                   value: '68c5176141525884106506254veg8yhcdsdpgpsy',                                                                domain: '.xiaohongshu.com',         path: '/' },
  { name: 'customerClientId',                   value: '197999501906426',                                                                                         domain: '.xiaohongshu.com',         path: '/' },
  { name: 'galaxy_creator_session_id',          value: 'A2M6B7ulLHuAHVgZVi2XHF24b2YUZ95EDpky',                                                                   domain: '.xiaohongshu.com',         path: '/' },
  { name: 'galaxy.creator.beaker.session.id',  value: '1772808048431053201335',                                                                                   domain: '.xiaohongshu.com',         path: '/' },
  { name: 'gid',                                value: 'yYfDJ0dj2fUWyYfDJ0djy3xlqDYi7DVuySViCTS7kKWFvxq8FWjuxf88848W2jJ8dWifWS8D',                              domain: '.xiaohongshu.com',         path: '/' },
  { name: 'loadts',                             value: '1772808048854',                                                                                            domain: '.xiaohongshu.com',         path: '/' },
  { name: 'sec_poison_id',                      value: '2c115713-450c-4325-a3f6-94402d93680f',                                                                    domain: '.xiaohongshu.com',         path: '/' },
  { name: 'web_session',                        value: '0400698c487a65176b42398e0a3b4bbbf2bdaf',                                                                   domain: '.xiaohongshu.com',         path: '/' },
  { name: 'webId',                              value: '8f8168df1f263779d5ba6618431e149e',                                                                         domain: '.xiaohongshu.com',         path: '/' },
  { name: 'websectiga',                         value: '7750c37de43b7be9de8ed9ff8ea0e576519e8cd2157322eb972ecb429a7735d4',                                         domain: '.xiaohongshu.com',         path: '/' },
